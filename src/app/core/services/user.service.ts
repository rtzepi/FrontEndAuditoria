...
// import { Observable } from 'rxjs';
// import { environment } from '../../environments/environment.development';
// import { IUser, IUserResponse, IUserRegisterRequest, IUserUpdateRequest } from '../../shared/models/IUser';
...
//   registerUser(userData: IUserRegisterRequest): Observable<IUserResponse> {
//     const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
//     return this.http.post<IUserResponse>(`${this.apiUrl}/register`, userData, { headers });
//   }

//   updateUser(id: number, userData: IUserUpdateRequest): Observable<IUserResponse> {
//     const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
//     return this.http.put<IUserResponse>(`${this.apiUrl}/${id}`, userData, { headers });
//   }
...
// import { Observable } from 'rxjs';
// import { environment } from '../../environments/environment.development';
// import { IUser, IUserRegisterRequest, IUserResponse } from '../../shared/models/IUser';
...
//   updateUser(id: number, userData: Partial<IUser>): Observable<IUserResponse> {
//     const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
//     return this.http.put<IUserResponse>(`${this.apiUrl}/${id}`, userData, { headers });
//   }
